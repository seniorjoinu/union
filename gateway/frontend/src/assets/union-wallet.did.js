export const idlFactory = ({ IDL }) => {
  ...
  const GetAccessConfigRequest = IDL.Record({ 'id' : AccessConfigId });
  ...
  const GetBatchRequest = IDL.Record({ 'id' : BatchId });
  ...
  const GetGroupRequest = IDL.Record({ 'group_id' : GroupId });
  const TokenId = Id;
  ...
  const GetGroupsOfRequest = IDL.Record({ 'principal_id' : IDL.Principal });
  ...
  const GetPermissionRequest = IDL.Record({ 'id' : PermissionId });
  ...
  const GetProfileRequest = IDL.Record({ 'id' : ProfileId });
  ...
  const GetTotalGroupSharesRequest = IDL.Record({ 'group_id' : GroupId });
  const GetTotalGroupSharesResponse = IDL.Record({ 'total' : Shares });
  const GetVotingRequest = IDL.Record({ 'id' : VotingId });
  ...
  const GetVotingConfigRequest = IDL.Record({ 'id' : VotingConfigId });
  ...
  const GetVotingResultsRequest = IDL.Record({ 'voting_id' : VotingId });
  ...
  const ListBatchesRequest = IDL.Record({ 'page_req' : PageRequest });
  ...
  const ListChunksRequest = IDL.Record({ 'page_req' : ListChunksPageRequest });
  ...
  const ListGroupsRequest = IDL.Record({ 'page_req' : PageRequest });
  ...
  const ListProfilesRequest = IDL.Record({ 'page_req' : PageRequest });
  ...
  const ChoiceFilter = IDL.Record({ 'voting_id' : VotingId });
  ...
  const ListVotingsRequest = IDL.Record({ 'page_req' : PageRequest });
  ...
  return IDL.Service({
    ...
    'get_settings' : IDL.Func([], [GetSettingsResponse], ['query']),
