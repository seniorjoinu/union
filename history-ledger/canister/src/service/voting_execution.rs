...
use crate::repository::voting_execution::types::{VotingExecutionRecordExternal, VotingExecutionRecordFilter, VotingExecutionRepositoryError};
use shared::pageable::{Page, PageRequest};
use shared::remote_call::ProgramExecutionResult;
use shared::types::wallet::{ChoiceExternal, ChoiceId, VotingId};
...
) -> Result<Page<(ChoiceId, ChoiceExternal)>, VotingExecutionServiceError> {
    get_repositories()
        .voting_execution
