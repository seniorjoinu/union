...
use crate::controller::voting::api::{CastVoteRequest, CreateVotingChoiceRequest, CreateVotingChoiceResponse, CreateVotingRequest, CreateVotingResponse, DeleteVotingChoiceRequest, DeleteVotingRequest, GetVotingChoiceRequest, GetVotingChoiceResponse, GetVotingRequest, GetVotingResponse, ListVotingChoicesRequest, ListVotingChoicesResponse, ListVotingsRequest, ListVotingsResponse, UpdateVotingChoiceRequest, UpdateVotingRequest};
...
fn delete_voting(req: DeleteVotingRequest) {
    ...
    VotingService::delete_voting(&req.id)
        .expect("Unable to delete voting");
}
...
fn get_voting(req: GetVotingRequest) -> GetVotingResponse {
    ...
    let voting = VotingService::get_voting(&req.id)
        .expect("Unable to get voting");
