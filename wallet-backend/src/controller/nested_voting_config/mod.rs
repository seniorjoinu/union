use crate::controller::nested_voting_config::api::{
    CreateNestedVotingConfigRequest, CreateNestedVotingConfigResponse,
    DeleteNestedVotingConfigRequest, GetNestedVotingConfigRequest, GetNestedVotingConfigResponse,
    ListNestedVotingConfigsRequest, ListNestedVotingConfigsResponse,
...
#[update]
fn create_nested_voting_config(
    req: CreateNestedVotingConfigRequest,
...
fn get_nested_voting_config(req: GetNestedVotingConfigRequest) -> GetNestedVotingConfigResponse {
    only_self_or_with_access("get_nested_voting_config", req.query_delegation_proof_opt);
    ...
    GetNestedVotingConfigResponse {
        nested_voting_config,
    }
}

#[query]
fn list_nested_voting_configs(
    req: ListNestedVotingConfigsRequest,
) -> ListNestedVotingConfigsResponse {
    only_self_or_with_access("list_nested_voting_configs", req.query_delegation_proof_opt);
